var Akademi = (function () {
    ...
    var a = function () {
        ...
        C = function () {
            jQuery("#lightgallery ,#lightgallery-2").length > 0 && $("#lightgallery ,#lightgallery-2").lightGallery({ loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" });
        },
        k = function () {
            jQuery("#lightgallery-1").length > 0 && $("#lightgallery-1").lightGallery({ loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" });
        },
        w = function () {
