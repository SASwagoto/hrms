...
return [
    ...
    "social.profile.link"=> "Social Profile Link",
    ...
    "instagram.profile.url"=> "Intagram Profile URL",
    "update"=> "Update",

    //Role setting
    "user.role.settings"=> "User Role Settings",
    "assign.user.role"=> "Assign User Role",
    "add.new.role"=> "Add New Role",
    "add.new.permission"=> "Add New Permission",
    "give.role.permission"=> "Give Role Permission",
    ...
    "assign.role.permission"=> "Assign Role Permission",
