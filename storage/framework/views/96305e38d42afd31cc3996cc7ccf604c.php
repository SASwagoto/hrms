                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown all">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-0">
                            <div class="card mb-0">
                                <div class="card-header d-block h-auto border-0">
                    ...
                    <li class="nav-item dropdown notification_dropdown search-area-header">
                        ...
                        <div class="dropdown-menu dropdown-menu-end rounded p-0">
                            <div class="card mb-0">
                                <div class="card-body px-0">
                                    ...
                                    <div class="dlab-scroll height300 mt-3 px-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end of-visible">
                            ...
                            <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                <ul class="timeline">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media media-info me-2">
                                                KG
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media media-danger me-2">
                                                KG
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mb-1">Resport created successfully</h6>
                    ...
                    <li class="nav-item dropdown notification_dropdown" id="en">
                        <a class="nav-link me-0 <?php echo e(session('lang_code') == 'en' ? 'd-none' : ''); ?>" href="<?php echo e(route('langChange', 'en')); ?>">En</a>
                        <a class="nav-link me-0 <?php echo e(session('lang_code') == 'bn' ? 'd-none' : ''); ?>" href="<?php echo e(route('langChange', 'bn')); ?>">Bn</a>
                    </li>
                    <li class="nav-item">
...
<?php /**PATH C:\laragon\www\hrms\resources\views/layouts/partials/topbar.blade.php ENDPATH**/ ?>