            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="<?php echo e(route('zone.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table-striped table-responsive-sm table">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="view-mode-row">
                                            <form action="<?php echo e(route('zone.update', $zone->id)); ?>" method="POST" id="updateForm<?php echo e($key+1); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <td><?php echo e($key + 1); ?></td>
                                            <td class="view-mode"><?php echo e($zone->zone_name); ?></td>
                                            <td class="edit-mode" style="display: none;">
                                                <input type="text" class="form-control" name="zone_name" id="" value="<?php echo e($zone->zone_name); ?>">
                                            </td>
                                            <td class="view-mode" data-column-name="isActive">
                                                <span class="badge <?php echo e($zone->isActive ? 'badge-success' : 'badge-danger'); ?> light"><?php echo e($zone->isActive ? 'Active' : 'Inactive'); ?></span>
                                            </td>
                                            <td class="edit-mode" style="display: none;">
                                                <input type="checkbox" name="isActive" <?php if($zone->isActive): ?> checked <?php endif; ?>>
                                            </td>
                                            <td>
                                                <ul class="action_btn">
                                                    <li>
                                                    ...
                                                    <li><a href="javascript:void(0);" onclick="document.getElementById('delete-form<?php echo e($key+1); ?>').submit()"><i class="fa-solid fa-trash fa-xl"
                                                        style="color: #ff0000;"></i></a></li>
                                                </ul>
                                            </td>
                                            </form>
                                            <form action="<?php echo e(route('zone.delete', $zone->id)); ?>" method="POST" id="delete-form<?php echo e($key+1); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hrms\resources\views/department/zone.blade.php ENDPATH**/ ?>