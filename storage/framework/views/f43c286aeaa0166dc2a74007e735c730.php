...
<?php echo e(__('messages.add.new.permission')); ?>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('permission.create')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label for="role"><?php echo e(__('messages.permission.name')); ?></label>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\hrms\resources\views/settings/role/add_permission.blade.php ENDPATH**/ ?>