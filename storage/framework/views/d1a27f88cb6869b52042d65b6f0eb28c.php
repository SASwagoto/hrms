                    ...
                    <form action="<?php echo e(route('assign.sl')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="sector-select" class="form-control" name="sector_id">
                                ...
                                <?php if(empty($sector->sector_leader)): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hrms\resources\views/department/assign_sl.blade.php ENDPATH**/ ?>